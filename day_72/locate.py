...
# We are using Nominatim class of geocoders sub-module from geopy to find location(latitude , longitude) of two places. Geodesic is being used to find the distance between these two places.
